...
const Footer = () => {
  return (
    <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-400 mt-20">
      <div class="mx-auto max-w-screen-xl text-center">
        ...
        <p class="my-6 text-gray-500 dark:text-gray-800">
          Brindamos asesoramiento inmobiliario sobre venta y alquiler de
